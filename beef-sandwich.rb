...
def test_for_beef_sandwich
		...
		expect number_of_steps, 9, "should be the length of the beef array"

		step_1 = sandwich[0]
		expect step_1, "take 2 pieces of bread", "return the 1st element"

		step_2 = sandwich[1]
		expect step_2, "open beef jar", "return the 2nd element"

		step_3 = sandwich[2]
		expect step_3, "if there is beef in jar", "return the 3rd element"
		...
		step_7 = sandwich[6]
		expect step_7, "stick knife in beef jar", "return the 7th element"
